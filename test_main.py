...
def test_get_message():
    ...
    assert (
        main.get_message("Moi JJ HH:MM:SS host program[process_id]: message")
        == " message"
    )
...
def test_get_composed_message1():
    ...
    assert (
        main.get_message(
            "Moi JJ HH:MM:SS host program[process_id]: message : sous-message"
        )
...
def test_get_composed_message2():
    ...
    assert (
        main.get_message(
            "Moi JJ HH:MM:SS host program[process_id]: message : sous-message : sous-message : sous-message : sous-message"
        )
        == " message : sous-message : sous-message : sous-message : sous-message"
    )
...
def test_get_program_with_process_id():
    ...
    assert (
        main.get_program("Moi JJ HH:MM:SS host program[process_id]: message")
        == "program"
    )
...
def test_get_complete_date():
    ...
    assert (
        main.get_complete_date("Moi JJ HH:MM:SS host program[10]: message")
        == "Moi JJ HH:MM:SS"
    )
...
def test_formated_date_january():
    ...
    assert main.formatted_date("Jan 18 22:30:15") == "01:18 22:30:15"


def test_formated_date_february():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Feb 18 22:30:15") == "02:18 22:30:15"


def test_formated_date_march():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Mar 28 22:30:15") == "03:28 22:30:15"


def test_formated_date_april():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Apr 08 22:30:15") == "04:08 22:30:15"


def test_formated_date_may():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("May 08 22:30:15") == "05:08 22:30:15"


def test_formated_date_june():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Jun 18 22:30:15") == "06:18 22:30:15"


def test_formated_date_july():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Jul 18 22:30:15") == "07:18 22:30:15"


def test_formated_date_august():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Aug 10 22:30:15") == "08:10 22:30:15"


def test_formated_date_september():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Sep 01 22:30:15") == "09:01 22:30:15"


def test_formated_date_november():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Nov 18 22:30:15") == "11:18 22:30:15"


def test_formated_date_october():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Oct 18 22:30:15") == "10:18 22:30:15"


def test_formated_date_december():
    """Test unitaire pour formated_date"""
    assert main.formatted_date("Dec 18 22:30:15") == "12:18 22:30:15"
...
def test_logs_by_day1():
    ...
    expected = ["Jan 14 23:30:15 blabla", "Jan 14 24:30:15 blabla"]
    for elem in output:
...
def test_logs_between_limite_min():
    ...
    expected = ["Jan 14 24:30:15 blabla", "Jan 15 25:30:15 blabla"]
    for elem in output:
        assert elem in expected
    for elem in expected:
        assert elem in output
...
def test_logs_between_default_min():
    ...
    expected = ["Jan 13 22:30:15 blabla", "Jan 14 23:30:15 blabla"]
    for elem in output:
        assert elem in expected
    for elem in expected:
        assert elem in output
