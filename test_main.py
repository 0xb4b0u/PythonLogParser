...
def test_get_composed_message1():
    ...
    assert main.get_message(
        "Moi JJ HH:MM:SS host program[process_id]: message : sous-message") == " message : sous-message"


def test_get_composed_message2():
    """ Test unitaire pour get_message (avec plein de sous message) """
    assert main.get_message(
        "Moi JJ HH:MM:SS host program[process_id]: message : sous-message : sous-message : sous-message : sous-message") == " message : sous-message : sous-message : sous-message : sous-message"
...
def test_logs_by_day2():
    ...
    for elem in output:
        assert elem in ["Jan 13 22:30:15 blabla"]
